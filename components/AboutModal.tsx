...
export default function AboutModal({ isOpen, onClose }: AboutModalProps) {
  // 控制哪个收款码被放大（null = 没有，'wechat' = 微信，'alipay' = 支付宝）
          ...
          <div className="p-8">
            ...
            <div className="flex justify-center mb-6">
              <div className="relative">
                ...
                <div className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-white/20 shadow-xl">
                  {/* 新照片！注意文件名有空格，需要用 %20 编码 */}
                  <img src="/MyProfile%201.png" alt="BIGYQY" className="w-full h-full object-cover" />
                </div>
              </div>
            </div>
            ...
            <div className="prose prose-invert max-w-none mb-8">
              <div className="text-white/80 space-y-4 text-base leading-relaxed">
                ...
                <p className="text-sm text-white/50 border-l-4 border-blue-500 pl-4 py-2 bg-white/5 rounded">
              ...
              <div className="flex justify-center gap-8 flex-wrap">
                ...
                <div className="text-center">
                  ...
                  >
                    ...
                    {/* 二维码容器 */}
                    <div className="relative w-40 h-40 bg-white rounded-lg overflow-hidden shadow-lg group-hover:shadow-2xl transition-shadow">
                      <img src="/WeChatReciveMoneny.jpg" alt="微信收款码" className="w-full h-full object-cover" />

                      {/* 悬停提示 - 小手指示 */}
                      <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                        <div className="text-white text-center">
                          <div className="text-3xl mb-1 animate-bounce">👆</div>
                          <p className="text-xs">点击放大</p>
                        </div>
                      </div>
                    </div>
                  </button>
                  <p className="text-white/60 text-sm mt-3">微信</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  >
                    ...
                    {/* 二维码容器 */}
                    <div className="relative w-40 h-40 bg-white rounded-lg overflow-hidden shadow-lg group-hover:shadow-2xl transition-shadow">
                      <img src="/ZhiFuBaoReciveMoneny.jpg" alt="支付宝收款码" className="w-full h-full object-cover" />
                  ...
                  <p className="text-white/60 text-sm mt-3">支付宝</p>
                </div>
              </div>
        ...
        <>
          ...
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 pointer-events-none">
            <div className="pointer-events-auto animate-slide-up">
              ...
              {/* 大图二维码 */}
              <div className="bg-white p-4 rounded-2xl shadow-2xl max-w-md mx-auto">
                <img
                  src={enlargedQR === 'wechat' ? '/WeChatReciveMoneny.jpg' : '/ZhiFuBaoReciveMoneny.jpg'}
                  alt={enlargedQR === 'wechat' ? '微信收款码' : '支付宝收款码'}
                  className="w-full h-auto rounded-lg"
                />
                <p className="text-center text-gray-600 mt-4 text-lg font-semibold">
                  {enlargedQR === 'wechat' ? '微信扫一扫' : '支付宝扫一扫'}
                </p>
              </div>
